  ...
  return (
    <div className="FifthPage" id="Contact">
      <div className="fifthpagecontent">
        ...
        <ul>
          <li>
            <a target="_blank" href="https://t.me/derdart">
              <svg
          ...
          <li>
            <a target="_blank" href="https://www.instagram.com/derdart_inst/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
      ...
      <a target="_blank" className="big" href="https://github.com/Derdart">
        <div className="ghcontent">
          <h1>GitHub</h1>
          <p>
            Check out my GitHub profile. <br /> There you can find all my
            projects.
          </p>
        </div>
        <svg
